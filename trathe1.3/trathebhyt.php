...
<div class="fup">
    <form class="ftk" id="form_upload" method="POST" enctype="multipart/form-data">
        ...
        <Button type="submit" name="submit" >Đọc file danh sách đối tượng cần tra cứu</Button><br/>
    </form>
</div>
<?php
session_start();
...
echo "<div class='dshs'><table class='tbhs'><tr><th>STT</th><th>Họ tên</th><th>Ngày Sinh</th></tr>";
