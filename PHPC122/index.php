...
if (isset($_POST['submit'])) {
	...
	foreach($listSheet as $ls){
		...
		echo "<Button class='btluu' type='button' name='btluu' onclick='load_ajax(this)' value='".$ls."-".$i."'>Lưu dữ liệu : ".$ls."</Button>";
		$i++;
		
	}
	
	echo "</Select>";
	echo "<input type='text' class='hidden' name='file' value=".$file."/>";
