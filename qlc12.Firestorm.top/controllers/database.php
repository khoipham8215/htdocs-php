...
class Database
{
     ...
     * @var string
     */
    private $username = 'dulieuc12';
    /**
     * $password Mật khẩu truy cập sql
     * @var string
     */
    private $password = 'Hvcv0102@';
    /**
     * $databaseName Tên Database các bạn muốn kết nối
     * @var string
     */
    private $databaseName = 'dulieuc12';
    /**
     * $charset Dạng ký tự
     * @var string
     */
    ...
    public function query($sql ='', $return = true)
    {
        ...
        {
            if($return === true){
				//$row = mysqli_fetch_array($result) or die("kết nối thất bại !");
                while ($row = mysqli_fetch_array($result)) {
                    $data[] = $row;
                }
                mysqli_free_result($result);
