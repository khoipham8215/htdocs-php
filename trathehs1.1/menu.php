...
<div class="topnav">
    ...
    <a  href="index.php?controller=trathehs" onClick="loadTab(this)">Tra thẻ BHYT học sinh</a>
    <a  href="index.php?controller=bccssk" onClick="loadTab(this)">Báo cáo CKSK</a>
	 <a  href="filemau/mautrathe.xlsx" >Tải file mẫu tra thẻ</a>
	  <a  href="index.php?controller=trathett" >Tra từng người</a>
