...
//$file;$objFile;$objData;$objPHPExcel;
?>
...
if (isset($_POST['submit'])) {
	...
	//$f=explode("_",$_FILES["fileUpload"]["name"]);
	echo "Đọc file : ".$_FILES["fileUpload"]["name"];
	//echo "<br/> Lưu dữ liệu tháng : ".substr($f[4],0,6);
	$objFile=PHPExcel_IOFactory::identify($file);
	$objData=PHPExcel_IOFactory::createReader($objFile);
	// Đọc ds các sheet
	$listSheet=$objData->listWorkSheetNames($file);
	echo "<br/> Lưu sheet :".$listSheet[0];
	//print_r($listSheet);
	LuuDuLieu(0,$listSheet[0],$file);
