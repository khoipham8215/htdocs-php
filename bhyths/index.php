	...
	<div class="container-fluid" >
		...
		<div class="navbar navbar-collapse" id="navbarResponsive" >
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="index.php?controller=trac12">Tra thẻ BHYT</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index.php?controller=tonghopc12">Lập danh sách D03</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index.php?controller=qlhs">Quản lý học sinh</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index.php?controller=qlld">Quản lý trường</a>
				</li>
...
switch($_GET['controller']){
	...
	break;
	case 'qlhs': if(!empty($_SESSION['user'])){include_once('controllers/qlhs.php');}
	break;
